...
public class BuscarRevisor extends javax.swing.JInternalFrame {
    public int auxid;
   
    public BuscarRevisor() {
    ...
    public BuscarRevisor( String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
...
//    }
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        ...
        if (jtDni.getText().isEmpty()) {
            ...
            if(InspectorData.buscarInspectorDni(Integer.parseInt(jtDni.getText()),0)!=null){
