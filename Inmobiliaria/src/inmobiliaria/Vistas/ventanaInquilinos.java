 ...
 * @author Ian
 */
public class ventanaInquilinos extends javax.swing.JInternalFrame {
    ...
    public ventanaInquilinos( String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 240, 290, 90));
        ...
        jLabel7.setText("  EDITAR INQUILINO");
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        ModificarInquilino mi=new ModificarInquilino();
        escritorio.removeAll();
        escritorio.repaint();
        mi.setVisible(true);
        escritorio.add(mi);
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        BuscarInquilino bi=new BuscarInquilino();
        escritorio.removeAll();
        escritorio.repaint();
        bi.setVisible(true);
        escritorio.add(bi);
        escritorio.moveToFront(bi);
